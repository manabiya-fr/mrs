...
class Frame:
    ...
    def plot(self, ax=None, scale=1.0):
        ...
        # name of arrows
        ax.text(pos[0] + x_axis[0]*1.1, pos[1] + x_axis[1]*1.1, pos[2] + x_axis[2]*1.1, 
                'X', color='red', fontsize=12, fontweight='bold')
        ax.text(pos[0] + y_axis[0]*1.1, pos[1] + y_axis[1]*1.1, pos[2] + y_axis[2]*1.1, 
                'Y', color='green', fontsize=12, fontweight='bold')
        ax.text(pos[0] + z_axis[0]*1.1, pos[1] + z_axis[1]*1.1, pos[2] + z_axis[2]*1.1, 
